...
namespace XFramework.TerrainMoudule
{
    ...
    /// </summary>
    public partial class TerrainManager : IGameModule
    {
        ...
        //public  void FlattenRoad(Vector3 pos_0, Vector3 pos_1, Vector3 pos_2, Vector3 pos_3, RoadsOrBridges road)
        //{
        ...
        //public  void RecoverRoadTerrainData(RoadsOrBridges road)
        //{
        //    if (road != null)
        //    {
        ...
        /// 用于地形操作的撤回
        /// </summary>
        private Stack<TerrainCmdData> terrainDataStack = new Stack<TerrainCmdData>();
        private Dictionary<Terrain, float[,]> terrainDataDic = new Dictionary<Terrain, float[,]>();
    ...
    public class TDInfo
    {
        ...
        /// 高度图分辨率
        /// </summary>
        public int heightMapRes { get; private set; }
        /// <summary>
        /// alphaMap分辨率
        /// </summary>
        public int alphaMapRes { get; private set; }
